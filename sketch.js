...
function setup() {
  ...
  ground = new Ground(450,520,9000,20);
  stand1 = new Ground(1090,300,250,10);
  stand2 = new Ground(700,200,200,10);
 /* block1 = new Block(100,275,30,40);
  block1.scale=2.0;
block2 = new Block(1030,275,30,40);
block3 = new Block(1060,275,30,40);
block4 = new Block(1090,275,30,40);
block5 = new Block(1120,275,30,40);
block6 = new Block(1150,275,30,40);
block7 = new Block(1180,275,30,40);*/
//level two
...
block17 = new Block(800,275,30,40)
...
blocks9 = new Block(700,95,30,40);
  ball = new Polygon(200,200,150,150)
 
  band= new Band(ball.body,{x:300, y:75});
}
...
function draw() {
 ...
 text("Hit the zombies to escape🙂🙂🙂",1000,100)
